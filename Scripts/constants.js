...
// var playercamp = confirm("Want to play :\n\nOk:Mario\nCancel:Enemies\n")
// player = playercamp==true?"mario":"goomba"
player="mario"
player2= player=='mario'?'luigi':'koopa'
 var images = {
	// sprites : BASEPATH + counterplayer!=1?'mario-sprites.png':confirm("OK:Mario\nCancel:Luigi")==true?'mario-sprites.png':"luigi-sprites.png",
	sprites : BASEPATH + player +"-sprites.png",
	spritesf : BASEPATH + player +'-fire.png',
	spritesfb : BASEPATH + player +'-blueshell.png',
	spritesl: BASEPATH + player2 +"-sprites.png",
	spriteslf: BASEPATH + player2 +"-fire.png",
	spriteslfb : BASEPATH + player2 +'-blueshell.png',
	spritesp: BASEPATH + "peach-sprites.png",
	spritespf: BASEPATH + "peach-fire.png",
	spritespfb : BASEPATH + 'peach-blueshell.png',
	enemies : BASEPATH + player +'-enemies.png',
	enemiesl : BASEPATH + player +'-enemiess.png',
